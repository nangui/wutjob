                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="flex flex-col">
                        ...
                        <div class="mt-5">
                            ...
                            @endif
                            <form method="POST" action={{ route('user.cv.update') }} class="w-full">
                                @csrf
                                @method('PUT')
                                <div class="w-full flex gap-5">
                                    ...
                                    <div class="w-1/4">
                                        ...
                                        <input id="age"
                                            ...
                                            min="18" value={{ $profile->age }} type="number" name="age" required
                                            autofocus />
                                    </div>
                                    ...
                                    <div class="w-1/4">
                                        ...
                                        <textarea id="address" name="address"
                                            class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 block mt-1 w-full">{{ $profile->address }}</textarea>
                                    </div>
                                    ...
                                    <div class="w-1/4">
                                        ...
                                        <input id="phone"
                                            class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 block mt-1 w-full"
                                            value="{{ $profile->phone }}" type="tel" inputmode="numeric" name="phone"
                                            required />
                                    </div>
                                    ...
                                    <div class="w-1/4">
                                        ...
                                        <input id="speciality"
                                            class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 block mt-1 w-full"
                                            value="{{ $profile->speciality }}" type="text" name="speciality" required />
                                    </div>
                                </div>
                                ...
                                <div class="w-full flex gap-5">
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <input id="level"
                                            ...
                                            type="text" value="{{ $profile->level }}" name="level" required />
                                    </div>
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <input id="experience"
                                            class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 block mt-1"
                                            value="{{ $profile->experience }}" type="number" min="1" name="experience"
                                            required />
                                    </div>
                                </div>
